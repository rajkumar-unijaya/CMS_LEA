...
<!--Kesalahan-->
              ...
              <div class="row">
                            <div class="col-md col-sm">
                                ...
                                <select id='search' multiple='multiple' name="from[]" class="form-control" size="10" style="font-size:14px;important!" readonly>
                                    
                                    <option value="{{$activity->kod}}">
                                        
                                    </option>
                                   
                                </select>
                                <div class='control-label count-from'  style="margin:10px;" readonly>
                            ...
                            <div class="col-md col-sm">
                                        ...
                                        <select name="aktiviti_kod[]" multiple="multiple" id="search_to" class="form-control"
                                            size="10" multiple="multiple" required style="font-size:14px;important!" readonly>
          ...
          <div class="col-md-6">
                  <div class="form-group">
                      <label>Surat Rasmi</label><br>
                          ...
                          <div id="fileList">Name of file.doc <!-- show the file name -->
                                      </div>
                            ...
                            <div class="text-right">
                                <?//= Html::submitButton('Simpan', ['class' => 'btn  waves-effect-light btn-info btn-sm btnSave']) ?>
                                    <a href="../block-request-list"
                                        class="btn waves-effect-light btn-info btn-sm" data-toggle="tooltip"
                                        data-placement="left" title=""
                                        data-original-title="Click to cancel and back to the main page"><i
                                            class="ti-close"></i>
                                        Kemaskini</a> <!-- if user click kemaskini button it will go to edit page -->
