...
return [
    ...
    "DreamFactoryContextURL" => 'http://192.168.85.15/api/v2/crud-api/table/records/', 
    "DreamFactoryContextURLProcedures" => 'http://192.168.85.15/api/v2/crud-api/procedure/',
    "DreamFactoryContextURLCrawler" => 'http://192.168.85.15/api/v2/crawler/',
